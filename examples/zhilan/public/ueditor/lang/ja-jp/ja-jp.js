...
UE.I18N['en'] = {
    'labelMap':{
        'anchor':'Anchor', 'undo':'取り消す', 'redo':'やり直し', 'bold':'大胆な', 'indent':'最初の行のインデント', 'snapscreen':'SnapScreen',
        'italic':'イタリック', 'underline':'アンダースコア', 'strikethrough':'取り消し線', 'subscript':'添字','fontborder':'文字の境界線',
        'superscript':'上付き文字', 'formatmatch':'フォーマットペインター ', 'source':'Source', 'blockquote':'見積もり',
        'pasteplain':'プレーンテキスト貼り付けモード', 'selectall':'すべて選択', 'print':'Print', 'preview':'プレビュー',
        'horizontal':'仕切り', 'removeformat':'クリアフォーマット', 'time':'Time', 'date':'Date',
        'unlink':'リンク解除', 'insertrow':'InsertRow', 'insertcol':'InsertCol', 'mergeright':'MergeRight', 'mergedown':'MergeDown',
        ...
        'mergecells':'MergeCells', 'deletetable':'DeleteTable', 'cleardoc':'空のドキュメント', 'insertparagraphbeforetable':"InsertParagraphBeforeTable",
        'fontfamily':'フォント', 'fontsize':'フォントサイズ', 'paragraph':'段落形式','simpleupload':'Single Image','insertimage':'Multi Image','edittable':'Edit Table', 'edittd':'Edit Td','link':'ハイパーリンク',
        'emotion':'絵文字', 'spechars':'Spechars', 'searchreplace':'SearchReplace', 'map':'BaiduMap', 'gmap':'GoogleMap',
        'insertvideo':'Video', 'help':'Help', 'justifyleft':'左揃え', 'justifyright':'右揃え', 'justifycenter':'中央に揃える',
        'justifyjustify':'正当化 ', 'forecolor':'フォントの色', 'backcolor':'背景色', 'insertorderedlist':'注文リスト',
        'insertunorderedlist':'順不同リスト', 'fullscreen':'FullScreen', 'directionalityltr':'EnterFromLeft', 'directionalityrtl':'EnterFromRight',
        ...
        'lineheight':'行間隔','edittip':'EditTip','customstyle':'カスタムタイトル', 'scrawl':'Scrawl', 'autotypeset':'AutoTypeset',
        'webapp':'WebAPP', 'touppercase':'大文字', 'tolowercase':'小文字','template':'Template','background':'Background','inserttable':'InsertTable',
        'music':'Music', 'charts': 'charts','drafts': 'Load from Drafts', 'custombtn': '写真をアップロードする'
    },
    'insertorderedlist':{
        'num':'1,2,3...',
        'num1':'1),2),3)...',
    ...
    link:{
        'static':{
            'lang_input_text':'テキストコンテンツ：',
            'lang_input_url':'リンクアドレス：',
            'lang_input_title':'題名：',
            'lang_input_target':'新しいウィンドウで開くかどうか：'
        },
        'validLink':'リンクが選択されている場合にのみ有効になります',
